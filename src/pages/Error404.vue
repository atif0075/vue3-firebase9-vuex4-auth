<template>
  <section class="bg-dark absolute py-[120px] z-50 h-screen w-full">
    <div class="container">
      <div class="flex -mx-4">
        <div class="w-full px-4">
          <div class="mx-auto max-w-[400px] text-center">
            ...
            >Oops! That page can’t be found</h4>
            <p class="text-lg text-white mb-8">The page you are looking for it maybe deleted</p>
            <router-link
              to="/"
              class="text-base font-semibold text-white inline-block text-center border border-white rounded-lg px-8 py-3 hover:bg-white hover:text-dark transition"
